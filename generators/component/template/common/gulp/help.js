...
gulp.task('help', ()=> {
  ...
  util.log(util.colors.green('$ gulp kss:build        -- Will generate your components style guide into the /dist folder'));
  util.log(util.colors.green('$ gulp kss              -- Will generate your components style guide and render it for you to review'));
